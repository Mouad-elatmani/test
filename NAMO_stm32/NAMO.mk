...
#                        of executable (1/0)?
MODEL                = NAMO
MODULES              = NAMO_ADC.c NAMO_DAC.c NAMO_data.c main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c stm32xxxx_it.c
MODULES_OBJ          = NAMO_ADC.obj NAMO_DAC.obj NAMO_data.obj main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj stm32xxxx_it.obj 
MAKEFILE             = NAMO.mk
TOOLPATH             = "|>COMPILERPATH<|"
MATLAB_ROOT          = "E:/matlab"
ALT_MATLAB_ROOT      = "E:/matlab"
MATLAB_BIN           = "E:/matlab/bin"
ALT_MATLAB_BIN       = "E:/matlab/bin"
S_FUNCTIONS_LIB      = 
NUMST                = 1
NCSTATES             = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = NAMO_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -IC:/Users/ORIGIN~1/ONEDRI~1/Desktop/T/NAMO  -IC:/Users/ORIGIN~1/ONEDRI~1/Desktop/T/NAMO/NAMO_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -I$(MATLAB_ROOT)/STM32-MAT/STM32/addSrc/inc 
...
%.o: $(subst ",,$(MATLAB_ROOT)/STM32-MAT/STM32/addSrc/src)/%.cpp
	@echo ### Source $< done
...
%.o: $(subst ",,$(MATLAB_ROOT)/STM32-MAT/STM32/addSrc/src)/%$(SRC_FILE_EXT)
	@echo ### Source $< done
